    ...
    if (
      ...
      if (RegExp.$1.indexOf("/prod/") === -1) {
        ...
        __tealium_default_path =
          "//tags.tiqcdn.com/utag/usbank/digital-banking/prod/";
      }
    }
  })();
} catch (e) {}
...
if (typeof utag == "undefined" && !utag_condload) {
    ...
    for (var l in utag.loader.GV(c)) {
      switch (l) {
        ...
        case "24":
          try {
            c[24] |=
              d["dom.domain"].toString().indexOf("www.usbank.com") > -1 ||
              d["dom.domain"].toString().indexOf("emp.usbank.com") > -1 ||
              d["dom.domain"]
                .toString()
                .indexOf("investingoptions.usbank.com") > -1;
          } catch (e) {
            utag.DB(e);
          }
          break;
  ...
  utag.loader.GET = function () {
    ...
    utag.handler.cfg_extend = [
      { id: "21", blr: 0, end: 1, bwq: 0, alr: 0 },
      { bwq: 0, alr: 1, blr: 0, end: 0, id: "23" },
    ];
    utag.loader.initcfg = function () {
      ...
      utag.loader.cfgsort = ["21", "18", "16", "19", "33", "34"];
    };
    utag.loader.initcfg();
  };
